...
* **cadastrarCliente(Cliente clientes[], int *qtdClientes)**: Cadastra um novo cliente no array de clientes, aumentando a quantidade total de clientes. Pede ao usuário que insira os dados do cliente.
